package SailTools::SailSignalSet;
...
SailTools::SailSignalSet - Dataset of signals
...
Perhaps a little code snippet.
    ...
    use SailTools::SailSignalSet;

    my $foo = SailTools::SailSignalSet->new();
    ...
...
New object of SailTools::SailSignalSet;
Usage:
  my $sail_signal_set = new SailTools::SailSignalSet ( \%cfg );
...
You can find documentation for this module with the perldoc command.
    ...
    perldoc SailTools::SailSignalSet
...
1; # End of SailTools::SailSignalSet
