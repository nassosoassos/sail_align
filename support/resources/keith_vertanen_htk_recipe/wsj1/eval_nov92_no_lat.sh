...
if [[ $6 != "cross" ]]
then
HVite -A -T 1 -t $3 -C $TRAIN_COMMON/configwi -H $TRAIN_WSJ1/$1/macros -H $TRAIN_WSJ1/$1/hmmdefs -S $WSJ0_DIR/nov92_test.scp -i $TRAIN_WSJ1/recout_nov92$2.mlf -w $TRAIN_WSJ0/wdnet_bigram -p $4 -s $5 $TRAIN_WSJ0/dict_5k $TRAIN_WSJ1/tiedlist >$TRAIN_WSJ1/hvite_nov92$2.log
else
HVite -A -T 1 -t $3 -C $TRAIN_COMMON/configcross -H $TRAIN_WSJ1/$1/macros -H $TRAIN_WSJ1/$1/hmmdefs -S $WSJ0_DIR/nov92_test.scp -i $TRAIN_WSJ1/recout_nov92$2.mlf -w $TRAIN_WSJ0/wdnet_bigram -p $4 -s $5 $TRAIN_WSJ0/dict_5k $TRAIN_WSJ1/tiedlist >$TRAIN_WSJ1/hvite_nov92$2.log
fi
