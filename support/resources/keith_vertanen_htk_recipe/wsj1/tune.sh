...
if [[ $1 != "cross" ]]
then
perl $TRAIN_SCRIPTS/ProcessNums.pl $TRAIN_WSJ0/insertion_scale $TRAIN_WSJ1/template_tune_nov92
else
perl $TRAIN_SCRIPTS/ProcessNums.pl $TRAIN_WSJ0/insertion_scale $TRAIN_WSJ1/template_tune_nov92_cross
fi
