...
HLEd -A -T 1 -n triphones1 -i wintri.mlf $TRAIN_WSJ0/mktri.led aligned2.mlf >hled_make_tri.log
else
# This version makes it into a cross word triphone MLF, the short pause
# phone will not block context across words.
HLEd -A -T 1 -n triphones1 -i wintri.mlf $TRAIN_WSJ0/mktri_cross.led aligned2.mlf >hled_make_tri.log
fi
...
HHEd -A -T 1 -B -H hmm9/macros -H hmm9/hmmdefs -M hmm10 $TRAIN_WSJ1/mktri.hed monophones1 >hhed_clone_mono.log
