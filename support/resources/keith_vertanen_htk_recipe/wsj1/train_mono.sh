...
mkdir -p $TRAIN_WSJ1/hmm5
cp -f $TRAIN_TIMIT/hmm8/* $TRAIN_WSJ1/hmm5
fi
...
mkdir -p $TRAIN_WSJ1/hmm5_text
HHEd -H $TRAIN_WSJ1/hmm5/hmmdefs -H $TRAIN_WSJ1/hmm5/macros -M $TRAIN_WSJ1/hmm5_text /dev/null $TRAIN_WSJ1/monophones1
...
HCompV -A -T 1 -C $TRAIN_COMMON/config -f 0.01 -m -S train.scp -M $TRAIN_WSJ1/hmm5_text -I $TRAIN_WSJ1/aligned2.mlf $TRAIN_TIMIT/proto >$TRAIN_WSJ1/hcompv.log
cp $TRAIN_TIMIT/macros $TRAIN_WSJ1/hmm5_text/macros
cat $TRAIN_WSJ1/hmm5_text/vFloors >> $TRAIN_WSJ1/hmm5_text/macros

$TRAIN_TIMIT/train_iter.sh $TRAIN_WSJ1 hmm5_text hmm6 monophones1 aligned2.mlf 3
$TRAIN_TIMIT/train_iter.sh $TRAIN_WSJ1 hmm6 hmm7 monophones1 aligned2.mlf 3
$TRAIN_TIMIT/train_iter.sh $TRAIN_WSJ1 hmm7 hmm8 monophones1 aligned2.mlf 3

# Do an extra round just so we end up with hmm9 and synched with the tutorial
$TRAIN_TIMIT/train_iter.sh $TRAIN_WSJ1 hmm8 hmm9 monophones1 aligned2.mlf 3
