...
echo "Training cross word triphones using TIMIT and WSJ0..."
echo ""
...
$TRAIN_WSJ0/eval_nov92.sh hmm42 _ro200_tb750_prune250_cross 250.0 -4.0 15.0 cross
...
$TRAIN_WSJ0/eval_nov92_no_lat.sh hmm42 _ro200_tb750_prune350_cross 350.0 -4.0 15.0 cross
