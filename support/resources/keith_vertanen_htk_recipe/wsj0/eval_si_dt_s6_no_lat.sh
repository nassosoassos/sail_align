...
rm -f $TRAIN_WSJ0/hvite_si_dt_s6$2.log $TRAIN_WSJ0/hresults_si_dt_s6$2.log
...
if [[ $6 != "cross" ]]
then
HVite -A -T 1 -t $3 -C $TRAIN_COMMON/configwi -H $TRAIN_WSJ0/$1/macros -H $TRAIN_WSJ0/$1/hmmdefs -S $WSJ1_DIR/si_dt_s6_test.scp -i $TRAIN_WSJ0/recout_si_dt_s6$2.mlf -w $TRAIN_WSJ0/wdnet_bigram -p $4 -s $5 $TRAIN_WSJ0/dict_5k $TRAIN_WSJ0/tiedlist >$TRAIN_WSJ0/hvite_si_dt_s6$2.log
else
HVite -A -T 1 -t $3 -C $TRAIN_COMMON/configcross -H $TRAIN_WSJ0/$1/macros -H $TRAIN_WSJ0/$1/hmmdefs -S $WSJ1_DIR/si_dt_s6_test.scp -i $TRAIN_WSJ0/recout_si_dt_s6$2.mlf -w $TRAIN_WSJ0/wdnet_bigram -p $4 -s $5 $TRAIN_WSJ0/dict_5k $TRAIN_WSJ0/tiedlist >$TRAIN_WSJ0/hvite_si_dt_s6$2.log
fi

# Now lets see how we did!  
cd $TRAIN_WSJ0
HResults -n -A -T 1 -I $TRAIN_WSJ0/si_dt_s6_words.mlf $TRAIN_WSJ0/tiedlist $TRAIN_WSJ0/recout_si_dt_s6$2.mlf >$TRAIN_WSJ0/hresults_si_dt_s6$2.log

# Add on a NIST style output result for good measure
HResults -n -h -A -T 1 -I $TRAIN_WSJ0/si_dt_s6_words.mlf $TRAIN_WSJ0/tiedlist $TRAIN_WSJ0/recout_si_dt_s6$2.mlf >>$TRAIN_WSJ0/hresults_si_dt_s6$2.log
